...
namespace Kogane.Internal
{
	...
	/// </summary>
	internal sealed class UniTMPRuleConstCreatorSettings
		: ScriptableObjectForProjectSettings<UniTMPRuleConstCreatorSettings>
	{
		//================================================================================
		// 定数
		//================================================================================
		private static readonly string PACKAGE_NAME              = "UniTMPRuleConstCreator";
		private static readonly string DEFAULT_OUTPUT_ASSET_PATH = "Assets/TMPRuleConst.cs";

		private static readonly string DEFAULT_CODE_TEMPLATE = @"namespace Kogane
{
    public static partial class TMPRuleConst
    {
